...
cara sistem bekerja dan cara mengoperasikannya.
...
| [QUICKSTART.md](./QUICKSTART.md) | Menyalakan frontend, API, Postgres, Redis, worker, dan local verification. |
...
| [SECURITY.md](./SECURITY.md) | Trust boundary, key/secrets, replay protection, SSRF, dan hardening checklist. |
| [TESTING.md](./TESTING.md) | Test matrix, command, coverage reconciliation/race, dan coverage gap. |
| [DEPLOYMENT.md](./DEPLOYMENT.md) | Topologi production, env, release order, worker operations, dan rollback. |
| [DESIGN_SYSTEM.md](./DESIGN_SYSTEM.md) | Typography, token, responsive layout, motion, 3D, accessibility, dan performance. |
...
5. `src/App.tsx` dan `src/components/RouteManager.tsx` untuk route frontend.
...
Contract audit, mainnet deployment, deployment automation, external alert delivery, browser-wallet
E2E, versioned migrations, dan SDK publik belum selesai kecuali statusnya nanti
